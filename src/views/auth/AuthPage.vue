...
<template>
  <section class="bg-white w-full">
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      <main
        class="flex items-start justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6"
      >
        <div class="max-w-xl w-full lg:max-w-3xl">
          ...
          <h2 class="mt-6 text-2xl font-bold text-gray-900">BLOGGING SPACE</h2>
