...
<template>
  <div class="w-full">
    <!-- <header>
      ...
      >
        <div
          class="flex gap-2 mr-4 items-center text-xl italic font-bold text-gray-700"
        >
          <img
            alt="blog logo"
            class=""
        ...
        <div class="flex gap-4">
          ...
          <router-link to="/login" class="p-2 overflow-hidden"
            >Login</router-link
          >
          <router-link to="/register" class="p-2 overflow-hidden"
